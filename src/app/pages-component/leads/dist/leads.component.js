...
var LeadsComponent = /** @class */ (function () {
    function LeadsComponent(_services, _dialog) {
        ...
        this.displayedColumns = ['Company Name', 'Company Type', 'Client Type', 'Country', 'City', 'Date of Contract', 'Status', 'Contact Name', 'Phone', 'Actions'];
        //*********************************************//
    ...
    LeadsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._services.service_general_get_noapi('GetClientPartnerProfile?lead_or_client=0').subscribe(function (r) {
            if (r.success) {
                var data_1 = r.result.value;
                console.log(r.result.value);
                _this._services.service_general_get('Catalogue/GetLifeCircle').subscribe(function (r) {
                    var catalogo = r.result;
                    for (var i = 0; i < data_1.length; i++) {
                        for (var j = 0; j < catalogo.length; j++) {
                            var element = catalogo[j];
                            if (data_1[i].idLifeCircle == element.id) {
                                data_1[i].idLifeCircle = element.lifeCircle1;
                            }
                        }
                    }
                    _this.datasource = new table_1.MatTableDataSource(data_1);
    ...
    LeadsComponent.prototype.consultaPermisos = function () {
        var _this = this;
    ...
    LeadsComponent.prototype.catalogos = function () {
    ...
    LeadsComponent.prototype.getcity = function (data) {
        var _this = this;
    ...
    LeadsComponent.prototype.showExportDialog = function () {
        var _this = this;
    ...
    LeadsComponent.prototype.applyFilter = function (event) {
        var filterValue = event.target.value;
        this.datasource.filter = filterValue.trim().toLowerCase();
    };
    LeadsComponent.prototype.applyFiltersBK = function () {
        var _this = this;
    ...
    LeadsComponent.prototype.clean = function () {
        var _this = this;
    ...
    //FILTRO FECHA//
    LeadsComponent.prototype.filteringServiceRecordTable = function () {
    ...
    //*******************************************//
    LeadsComponent.prototype.filterDate = function (date_in) {
