...
exports.DialogWorkPermitComponent = void 0;
...
var DialogWorkPermitComponent = /** @class */ (function () {
    function DialogWorkPermitComponent(formBuilder, dialogRef, data, _services, _dialog) {
    ...
    DialogWorkPermitComponent.prototype.ngOnInit = function () {
    ...
    DialogWorkPermitComponent.prototype.documentoscatalogos = function () {
    ...
    DialogWorkPermitComponent.prototype.getcatalogos = function () {
        var _this = this;
        this._services.service_general_get("Catalogue/GetStatusWorkOrder?category=2").subscribe((function (data) {
            console.log(data);
            if (data.success) {
    ...
    DialogWorkPermitComponent.prototype.getdata = function () {
        var _this = this;
        this._services.service_general_get("ImmigrationServices/GetWorkPermitById?id=" + this.data.service[0].id).subscribe((function (data) {
            if (data.success) {
                console.log(data);
    ...
    DialogWorkPermitComponent.prototype.getcity = function (visa) {
        var _this = this;
        this._services.service_general_get("Catalogue/GetState?country=" + visa.hostCountryId).subscribe((function (data) {
            if (data.success) {
                ...
                _this.request();
                if (_this.entryVisa.commentsWorkPermits.length == 0) {
                    _this.addReply();
                }
                _this.show = true;
    ...
    DialogWorkPermitComponent.prototype.request = function () {
        var _this = this;
    ...
    ///Documents catalogos
    DialogWorkPermitComponent.prototype.documentType = function (id) {
    ...
    DialogWorkPermitComponent.prototype.countryOrigin = function (id) {
    ...
    DialogWorkPermitComponent.prototype.getAppName = function (applicantId) {
    ...
    DialogWorkPermitComponent.prototype.showDocumentDialogDetails = function (document, service_line) {
    ...
    DialogWorkPermitComponent.prototype.doc = function () {
        document.getElementById("doc").click();
    };
    DialogWorkPermitComponent.prototype.dropped = function (files) {
        var _this = this;
        this.files = files;
                    ...
                    fileEntry_1.file(function (file) {
                        ...
                        reader_1.onload = function () {
                            ...
                            _this.temporalDocument.push({
                                ...
                                "fileRequest": encoded,
                                "fileExtension": ext[1],
                                "workPermitId": _this.entryVisa.id,
    ...
    DialogWorkPermitComponent.prototype.fileOver = function (event) {
        console.log(event);
    };
    DialogWorkPermitComponent.prototype.fileLeave = function (event) {
        console.log(event);
    };
    DialogWorkPermitComponent.prototype.addReminders = function () {
        this.entryVisa.reminderWorkPermits.push({
            id: 0,
            workPermitId: this.entryVisa.id,
            reminderDate: null,
            reminderComments: "",
    ...
    DialogWorkPermitComponent.prototype.removeReminder = function (i, id) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result) {
                if (id == 0) {
                    _this.entryVisa.reminderWorkPermits.splice(i, 1);
                }
                else {
                    _this._services.service_general_delete("ImmigrationServices/DeleteReminderWP?id=" + id).subscribe((function (data) {
                        if (data.success) {
    ...
    DialogWorkPermitComponent.prototype.DeleteOnline = function (id) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result) {
                _this._services.service_general_delete("ImmigrationServices/DeleteDocumentWP?id=" + id).subscribe((function (data) {
                    if (data.success) {
                        var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                            data: {
                                header: "Success",
    ...
    DialogWorkPermitComponent.prototype.DeleteOnlineof = function (i) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    DialogWorkPermitComponent.prototype.addDocument = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result.success) {
                result.workPermitId = _this.entryVisa.id;
                _this.temporalDocument.push(result);
            }
        });
    };
    DialogWorkPermitComponent.prototype.requestPayment = function (data) {
        var _this = this;
    ...
    DialogWorkPermitComponent.prototype.deletePaymentConcept = function (data) {
        var _this = this;
    ...
    DialogWorkPermitComponent.prototype.addReply = function () {
        console.log(this.user);
        this.entryVisa.commentsWorkPermits.push({
            "id": 0,
            "workPermitId": this.entryVisa.id,
            "reply": null,
            "userId": this.user.id,
    ...
    DialogWorkPermitComponent.prototype.save = function () {
        var _this = this;
        this.__loader__.showLoader();
        var data_comment_aux = this.entryVisa.commentsWorkPermits;
        this.entryVisa.commentsWorkPermits = [];
        for (var i_1 = 0; i_1 < data_comment_aux.length; i_1++) {
            if (data_comment_aux[i_1].reply != null && data_comment_aux[i_1].reply != undefined && data_comment_aux[i_1].reply.trim() != '') {
                data_comment_aux[i_1].user.profileUsers = [];
                this.entryVisa.commentsWorkPermits.push(data_comment_aux[i_1]);
            }
        }
        this.entryVisa.createdBy = this.user.id;
        console.log(this.entryVisa);
        var i = 0;
        this.entryVisa.documentWorkPermits = this.temporalDocument;
        this._services.service_general_put("ImmigrationServices/PutWorkPermit", this.entryVisa).subscribe((function (data) {
            if (data.success) {
                console.log(data);
                var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                    data: {
    ...
    DialogWorkPermitComponent = __decorate([
        core_1.Component({
            selector: 'app-dialog-work-permit',
            templateUrl: './dialog-work-permit.component.html',
            styleUrls: ['./dialog-work-permit.component.css']
        }),
        __param(2, core_1.Inject(dialog_1.MAT_DIALOG_DATA))
    ], DialogWorkPermitComponent);
    return DialogWorkPermitComponent;
}());
exports.DialogWorkPermitComponent = DialogWorkPermitComponent;
