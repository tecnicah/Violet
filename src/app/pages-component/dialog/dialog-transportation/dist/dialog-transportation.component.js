...
exports.DialogTransportationComponent = void 0;
...
var DialogTransportationComponent = /** @class */ (function () {
    function DialogTransportationComponent(dialogRef, data, _services, _dialog) {
    ...
    DialogTransportationComponent.prototype.ngOnInit = function () {
    ...
    DialogTransportationComponent.prototype.get_catalogos = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        this._services.service_general_get("Catalogue/GetStatusWorkOrder?category=19").subscribe((function (data) {
                            console.log(data);
                            if (data.success) {
                    ...
                    case 6:
                        ...
                        this._services.service_general_get('RelocationServices/GetTransportationById?applicatId=' + this.data.data.deliveredToId + '&service_order_id=' + this.data.data.workOrderId + '&type_service=' + this.data.data.home_host).subscribe((function (data) {
                            if (data.success) {
                                ...
                                _this.get_payment();
                                if (_this.transportation.commentTransportations.length == 0) {
                                    _this.addReply();
                                }
    ...
    DialogTransportationComponent.prototype.get_SupplierType = function () {
        var _this = this;
    ...
    DialogTransportationComponent.prototype.getInfo = function () {
    ...
    DialogTransportationComponent.prototype.addPaymentType = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            result.transportationId = _this.transportation.id;
            _this.transportation.paymentTransportations.push(result);
            console.log("cierre del dialog addPaymentType: ", _this.transportation.paymentTransportations);
        });
    };
    //EDIT PAYMENT//
    DialogTransportationComponent.prototype.editPaymentType = function (data, pos) {
        var _this = this;
        var dialogRef = this._dialog.open(dialog_addpayment_component_1.DialogAddpaymentComponent, {
            data: data,
            width: "95%"
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            _this.transportation.paymentTransportations[pos] = result;
            console.log("cierre del dialog EDIT PaymentType: ", _this.transportation.paymentTransportations);
        });
    };
    //**********************************************************************************//
    //**METHODS ADD DOCUMENT**//
    DialogTransportationComponent.prototype.addDocument = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result.success) {
                result.transportationId = _this.transportation.transportService[0].id;
    ...
    DialogTransportationComponent.prototype.deleteDocument_DB = function (id) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result) {
                _this._services.service_general_delete("RelocationServices/DeleteDocumentT?id=" + id).subscribe((function (data) {
                    if (data.success) {
    ...
    DialogTransportationComponent.prototype.deleteDocument_LOCAL = function (position) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    //**********************************************************************************//
    //**CONSULTA PAYMENT**//
    DialogTransportationComponent.prototype.get_payment = function () {
        var _this = this;
    ...
    DialogTransportationComponent.prototype.addPayment = function (data) {
        var _this = this;
    ...
    DialogTransportationComponent.prototype.editPayment = function (data) {
        var _this = this;
        data.type = 2;
        data.supplierType = 3;
        data.id = data.requestPaymentId;
    ...
    // delete payment
    DialogTransportationComponent.prototype.deletePaymentConcept = function (data) {
        var _this = this;
    ...
    DialogTransportationComponent.prototype.addReply = function () {
    ...
    DialogTransportationComponent.prototype.addReminder = function () {
    ...
    //**DELETE REMINDER**//
    DialogTransportationComponent.prototype.removeReminder = function (i, id) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result) {
                if (id == 0) {
                    ...
                    _this._services.service_general_delete("RelocationServices/DeleteReminderT?id=" + id).subscribe((function (data) {
                        if (data.success) {
                            var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                                data: {
                                    header: "Success",
    ...
    //***********************************************************************************//
    //DOCUMENT TYPE//
    DialogTransportationComponent.prototype.getDocument = function (id) {
    ...
    //NACIONALITY//
    DialogTransportationComponent.prototype.getNacionality = function (id) {
    ...
    //**********************************************************************************//
    DialogTransportationComponent.prototype.save = function () {
        var _this = this;
    ...
    DialogTransportationComponent.prototype.showDocumentDialogDetails = function (document, service_line) {
    ...
    //PRIVACY//
    DialogTransportationComponent.prototype.getPrivacyName = function (id) {
    ...
    DialogTransportationComponent = __decorate([
        core_1.Component({
    ...
    return DialogTransportationComponent;
}());
exports.DialogTransportationComponent = DialogTransportationComponent;
