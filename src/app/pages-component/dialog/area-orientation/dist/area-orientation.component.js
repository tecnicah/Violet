...
exports.AreaOrientationComponent = void 0;
...
var AreaOrientationComponent = /** @class */ (function () {
    function AreaOrientationComponent(dialogRef, data, _services, _dialog) {
        ...
        this.displayedColumnsSchool = ['Schooling No.', 'School Name', 'Dependent', 'Per Month', 'Currency', 'Schooling Status', 'Actions'];
        //PAYMENTS
    ...
    AreaOrientationComponent.prototype.ngOnInit = function () {
    ...
    AreaOrientationComponent.prototype.getAge = function (fecha) {
        var cumpleanos = new Date(fecha);
        var edad = this.date.getFullYear() - cumpleanos.getFullYear();
        var m = this.date.getMonth() - cumpleanos.getMonth();
        if (m < 0 || (m === 0 && cumpleanos.getDate() < this.date.getDate())) {
            edad--;
        }
        return edad;
    };
    AreaOrientationComponent.prototype.get_catalogos = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        _b.ca_requestType = _e.sent();
                        _c = this;
                        return [4 /*yield*/, this._services.getCatalogueFrom('GetCountry')];
                    case 3:
                        _c.nacionality = _e.sent();
                        _d = this;
                        return [4 /*yield*/, this._services.getCatalogueFrom('GetPrivacy')];
                    case 4:
                        _d.ca_privacy = _e.sent();
                        ...
                        this._services.service_general_get("Catalogue/GetStatusWorkOrder?category=13").subscribe((function (data) {
                            console.log(data);
                            if (data.success) {
                                _this.ca_estatus = data.result;
                            }
                        }));
                        this._services.service_general_get('RelocationServices/GetAreaOrientationById?id=' + this.data.data.service[0].id).subscribe((function (data) {
                            if (data.success) {
                                console.log('DATA CONSULTA: ', data);
                                _this.area_orientation = data.result;
                                _this.show = true;
                                if (_this.area_orientation.commentAreaOrientations.length == 0) {
                                    _this.addReply();
                                }
                                if (_this.area_orientation.housing == true) {
                                    _this.showPanelHousing = true;
                                }
                                if (_this.area_orientation.schooling == true) {
    ...
    //***********************************************************************************//
    //DATA TABLE HOUSING//
    AreaOrientationComponent.prototype.getDataHousing = function () {
        var _this = this;
    ...
    //***********************************************************************************//
    AreaOrientationComponent.prototype.getDataSchool = function () {
        var _this = this;
    ...
    AreaOrientationComponent.prototype.get_dependent = function () {
        var _this = this;
    ...
    //***********************************************************************************//
    //**CONSULTA PAYMENT**//
    AreaOrientationComponent.prototype.get_payment = function () {
        var _this = this;
    ...
    AreaOrientationComponent.prototype.displayPanelHosudig = function ($event) {
    ...
    //***********************************************************************************//
    //FUNCTION FOR SHOW PANEL HOUSING//
    AreaOrientationComponent.prototype.displayPanelSchooling = function ($event) {
    ...
    AreaOrientationComponent.prototype.addReminder = function () {
    ...
    //**DELETE REMINDER**//
    AreaOrientationComponent.prototype.removeReminder = function (i, id) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result) {
                if (id == 0) {
                    _this.area_orientation.reminderAreaOrientations.splice(i, 1);
                }
                else {
                    _this._services.service_general_delete("RelocationServices/DeleteReminderAO?id=" + id).subscribe((function (data) {
                        if (data.success) {
    ...
    AreaOrientationComponent.prototype.addReply = function () {
    ...
    //**********************************************************************************//
    //HOUSINGS//
    AreaOrientationComponent.prototype.HousingSpecs = function () {
        var data_ = {
    ...
    //NEW RECORD//
    AreaOrientationComponent.prototype.HomeDetailsnew = function () {
        var _this = this;
    ...
    //EDIT HOUSING//
    AreaOrientationComponent.prototype.editHousing = function (data) {
        var _this = this;
        data.supplierType = 3;
    ...
    //**********************************************************************************//
    //AGREGAR ESCUELA//
    AreaOrientationComponent.prototype.addSchool = function () {
        var _this = this;
        var data_ = {
            id: 0,
    ...
    //EDITAR ESCUELA//
    AreaOrientationComponent.prototype.editSchool = function (data_) {
        var _this = this;
    ...
    AreaOrientationComponent.prototype.addPayment = function () {
        var _this = this;
        var data = {
    ...
    AreaOrientationComponent.prototype.editPayment = function (data) {
        var _this = this;
        data.type = 2;
        data.supplierType = 3;
    ...
    AreaOrientationComponent.prototype.deletePaymentConcept = function (data) {
        var _this = this;
    ...
    AreaOrientationComponent.prototype.addDocument = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result.success) {
                result.areaOrientationId = _this.area_orientation.id;
    ...
    AreaOrientationComponent.prototype.deleteDocument_DB = function (id) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result) {
                _this._services.service_general_delete("RelocationServices/DeleteDocumentAO?id=" + id).subscribe((function (data) {
                    if (data.success) {
                        var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                            data: {
                                header: "Success",
    ...
    AreaOrientationComponent.prototype.deleteDocument_LOCAL = function (position) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    //**********************************************************************************//
    //DOCUMENT TYPE//
    AreaOrientationComponent.prototype.getDocument = function (id) {
    ...
    //NACIONALITY//
    AreaOrientationComponent.prototype.getNacionality = function (id) {
    ...
    //GRADE//
    AreaOrientationComponent.prototype.getGrade = function (id) {
    ...
    //APPLICANT//
    AreaOrientationComponent.prototype.getApplicant = function (id) {
    ...
    //PRIVACY//
    AreaOrientationComponent.prototype.getPrivacyName = function (id) {
    ...
    //**********************************************************************************//
    //ELIMINAR HIJO//
    AreaOrientationComponent.prototype.deleteChild = function (pos) {
        this.area_orientation.schoolingAreaOrientations[pos].active = false;
    };
    //AGREGAR HIJO//
    AreaOrientationComponent.prototype.addChild = function () {
        var _this = this;
        if (this.area_orientation.schoolingAreaOrientations.length > 0) {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
                if (result.success) {
                    _this.area_orientation.schoolingAreaOrientations = result;
    ...
    //**********************************************************************************//
    AreaOrientationComponent.prototype.save = function () {
        var _this = this;
        this.loader.showLoader();
        ...
        var data_comment_aux = this.area_orientation.commentAreaOrientations;
        ...
        this._services.service_general_put("RelocationServices/PutAreaOrientation", this.area_orientation).subscribe((function (data) {
            if (data.success) {
                console.log(data);
                var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                    data: {
    ...
    AreaOrientationComponent.prototype.showDocumentDialogDetails = function (document, service_line) {
    ...
    AreaOrientationComponent = __decorate([
        core_1.Component({
    ...
    return AreaOrientationComponent;
}());
exports.AreaOrientationComponent = AreaOrientationComponent;
