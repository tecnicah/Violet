...
exports.DialogDocumentsComponent = void 0;
var core_1 = require("@angular/core");
var dialog_1 = require("@angular/material/dialog");
var DialogDocumentsComponent = /** @class */ (function () {
    function DialogDocumentsComponent(_services, dialogRef, data) {
    ...
    DialogDocumentsComponent.prototype.ngOnInit = function () {
        this.user = JSON.parse(localStorage.getItem('userData'));
        this.today = new Date();
        this.catalogos();
    };
    DialogDocumentsComponent.prototype.catalogos = function () {
    ...
    DialogDocumentsComponent.prototype.getDataToLibrarySettings = function (id_selected) {
        var _this = this;
        this.caRelation.forEach(function (item) {
            if (id_selected == item.id) {
                _this.library_data = item;
            }
        });
    };
    DialogDocumentsComponent.prototype.dropped = function (files) {
        var _this = this;
        this.files = files;
    ...
    DialogDocumentsComponent.prototype.fileOver = function (event) {
        console.log(event);
    };
    DialogDocumentsComponent.prototype.fileLeave = function (event) {
        console.log(event);
    };
    DialogDocumentsComponent.prototype.save = function () {
        this.temporalDocument = {
            "id": 0,
    ...
    DialogDocumentsComponent = __decorate([
        core_1.Component({
    ...
    return DialogDocumentsComponent;
}());
exports.DialogDocumentsComponent = DialogDocumentsComponent;
