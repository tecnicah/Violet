...
@Component({
  selector: 'app-print-ir',
  templateUrl: './print-ir.component.html',
  styleUrls: ['./print-ir.component.css']
})
export class PrintIrComponent implements OnInit {
  ...
  GetOnlyPropertyDetails(id_ph) {
    ...
    this.loader.showLoader();
    this._services.service_general_get("HousingList/GetOnlyPropertyDetails?key=" + id_ph + "&servide_detail_id=" + this.service_detail_id).subscribe((data => {
  ...
  GetOnlyPropertyInspRep(id_ph) {
    ...
    this.loader.showLoader();
    this._services.service_general_get("HousingList/GetOnlyPropertyInspRep?key=" + id_ph + "&servide_detail_id=" + this.service_detail_id + "&type=" + this.type_srv ).subscribe((data => {
      this.permanentHome_IR = data.result.value;
      console.log('ONLY INSPECTION & REPAIRS ========================================= : ', this.permanentHome_IR);
      this.llenarJSON();
