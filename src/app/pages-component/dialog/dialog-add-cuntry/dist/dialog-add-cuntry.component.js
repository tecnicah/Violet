...
exports.DialogAddCuntryComponent = void 0;
...
var DialogAddCuntryComponent = /** @class */ (function () {
    function DialogAddCuntryComponent(dialogRef, _services, data, _dialog) {
    ...
    DialogAddCuntryComponent.prototype.ngOnInit = function () {
        console.log('data que recibe country', this.data);
        if (this.data.documentLocationCountries) { }
        else {
    ...
    DialogAddCuntryComponent.prototype.consultaPermisos = function () {
        var _this = this;
    ...
    //*********************************************//
    DialogAddCuntryComponent.prototype.catalogos = function () {
    ...
    DialogAddCuntryComponent.prototype.DialogDocumentsLeadClientComponent = function (data) {
        var _this = this;
        if (data == null) {
            data = { id: 0 };
        }
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result.success) {
                result.idServiceLocationCountry = _this.data.id;
                result.updateDate = new Date();
                console.log(result);
                _this.data.documentLocationCountries.push(result);
            }
        });
    };
    DialogAddCuntryComponent.prototype.save = function () {
        this.data.success = true;
        this.dialogRef.close(this.data);
    };
    DialogAddCuntryComponent = __decorate([
        core_1.Component({
    ...
    return DialogAddCuntryComponent;
}());
exports.DialogAddCuntryComponent = DialogAddCuntryComponent;
