...
exports.DialogNewContactComponent = void 0;
...
var DialogNewContactComponent = /** @class */ (function () {
    function DialogNewContactComponent(_services, _dialog, dialogRef, data) {
        ...
        this.administrativeContactsServices = {
    ...
    //***********************************//
    DialogNewContactComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    //************************************************************//
    DialogNewContactComponent.prototype.verificaNodos = function () {
        if (this.data != null) {
    ...
    //************************************************************//
    DialogNewContactComponent.prototype.catalogos = function () {
    ...
    //*************************************************************//
    DialogNewContactComponent.prototype.addDocument = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result.success) {
                _this.administrativeContactsServices.documentAdministrativeContactsServices.push(result);
            }
        });
    };
    //*************************************************************//
    DialogNewContactComponent.prototype.editPhoto = function () {
        document.getElementById('photoCont').click();
    };
    DialogNewContactComponent.prototype.dropped = function (files) {
        var _this = this;
        this.files = files;
                ...
                fileEntry_1.file(function (file) {
                    ...
                    fileEntry_1.file(function (file) {
                        ...
                        reader_1.onload = function () {
                            ...
                            _this.administrativeContactsServices.photo = encoded;
                            _this.administrativeContactsServices.photoExtension = ext[1];
                            _this.administrativeContactsServices.b64 = imageUrl;
                            debugger;
                        };
                    });
                });
    ...
    //*************************************************************//
    DialogNewContactComponent.prototype.fileOver = function (event) {
        console.log(event);
    };
    //*************************************************************//
    DialogNewContactComponent.prototype.fileLeave = function (event) {
        console.log(event);
    };
    //*************************************************************//
    DialogNewContactComponent.prototype.nameDocument = function (id) {
    ...
    //************************************************************//
    DialogNewContactComponent.prototype.namePrivacy = function (id) {
    ...
    //************************************************************//
    DialogNewContactComponent.prototype.nameCity = function (id) {
    ...
    //*************************************************************//
    DialogNewContactComponent.prototype.deleteDocument = function (i) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result) {
                _this.administrativeContactsServices.documentAdministrativeContactsServices.splice(i, 1);
            }
        });
    };
    //************************************************************//
    DialogNewContactComponent.prototype.save = function () {
        this.administrativeContactsServices.success = true;
        this.dialogRef.close(this.administrativeContactsServices);
    };
    DialogNewContactComponent = __decorate([
        core_1.Component({
    ...
    return DialogNewContactComponent;
}());
exports.DialogNewContactComponent = DialogNewContactComponent;
