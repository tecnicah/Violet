...
exports.DialogVisaDeregistrationComponent = void 0;
...
var DialogVisaDeregistrationComponent = /** @class */ (function () {
    function DialogVisaDeregistrationComponent(formBuilder, dialogRef, data, _services, _dialog) {
    ...
    DialogVisaDeregistrationComponent.prototype.ngOnInit = function () {
    ...
    DialogVisaDeregistrationComponent.prototype.documentoscatalogos = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _a.caDocumentType = _e.sent();
                        _b = this;
                        return [4 /*yield*/, this._services.getCatalogueFrom('GetCountry')];
                    case 2:
                        _b.caCountry = _e.sent();
                        _c = this;
                    ...
                    case 4:
                        _d.cRequestType = _e.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    DialogVisaDeregistrationComponent.prototype.getcatalogos = function () {
        var _this = this;
        this._services.service_general_get("Catalogue/GetStatusWorkOrder?category=3").subscribe((function (data) {
            console.log(data);
            if (data.success) {
    ...
    DialogVisaDeregistrationComponent.prototype.getdata = function () {
        var _this = this;
        this._services.service_general_get("ImmigrationServices/GetVisaDeregistrationById?id=" + this.data.service[0].id).subscribe((function (data) {
            if (data.success) {
                console.log(data);
    ...
    DialogVisaDeregistrationComponent.prototype.getcity = function (visa) {
        var _this = this;
        console.log(visa);
        this._services.service_general_get("Catalogue/GetState?country=" + visa.hostCountryId).subscribe((function (data) {
            if (data.success) {
                ...
                if (_this.entryVisa.commentVisaDeregistrations.length == 0) {
                    _this.addReply();
                }
            }
        }));
    };
    DialogVisaDeregistrationComponent.prototype.request = function () {
        var _this = this;
    ...
    ///Documents catalogos
    DialogVisaDeregistrationComponent.prototype.showDocumentDialogDetails = function (document, service_line) {
    ...
    DialogVisaDeregistrationComponent.prototype.documentType = function (id) {
    ...
    DialogVisaDeregistrationComponent.prototype.countryOrigin = function (id) {
    ...
    DialogVisaDeregistrationComponent.prototype.getAppName = function (applicantId) {
    ...
    DialogVisaDeregistrationComponent.prototype.doc = function () {
        document.getElementById("doc").click();
    };
    DialogVisaDeregistrationComponent.prototype.dropped = function (files) {
        var _this = this;
        this.files = files;
                    ...
                    fileEntry_1.file(function (file) {
                        ...
                        reader_1.onload = function () {
                            ...
                            _this.temporalDocument.push({
                                ...
                                "fileRequest": encoded,
                                "visaDeregistrationId": _this.entryVisa.id,
    ...
    DialogVisaDeregistrationComponent.prototype.fileOver = function (event) {
        console.log(event);
    };
    DialogVisaDeregistrationComponent.prototype.fileLeave = function (event) {
        console.log(event);
    };
    DialogVisaDeregistrationComponent.prototype.addReminders = function () {
    ...
    DialogVisaDeregistrationComponent.prototype.removeReminder = function (i, id) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result) {
                if (id == 0) {
                    _this.entryVisa.reminderVisaDeregistrations.splice(i, 1);
                }
                else {
                    _this._services.service_general_delete("ImmigrationServices/DeleteReminderVD?id=" + id).subscribe((function (data) {
                        if (data.success) {
    ...
    DialogVisaDeregistrationComponent.prototype.DeleteOnline = function (id) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result) {
                _this._services.service_general_delete("ImmigrationServices/DeleteDocumentVD?id=" + id).subscribe((function (data) {
                    if (data.success) {
                        var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                            data: {
                                header: "Success",
    ...
    DialogVisaDeregistrationComponent.prototype.DeleteOnlineof = function (i) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    DialogVisaDeregistrationComponent.prototype.addDocument = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            result.visaDeregistrationId = _this.entryVisa.id;
            console.log(result);
            if (result.success) {
    ...
    DialogVisaDeregistrationComponent.prototype.requestPayment = function (data) {
        var _this = this;
        if (data == null) {
            data = {
    ...
    DialogVisaDeregistrationComponent.prototype.deletePaymentConcept = function (data) {
        var _this = this;
    ...
    DialogVisaDeregistrationComponent.prototype.addReply = function () {
    ...
    DialogVisaDeregistrationComponent.prototype.save = function () {
        var _this = this;
        this.__loader__.showLoader();
        ...
        var data_comment_aux = this.entryVisa.commentVisaDeregistrations;
        ...
        this._services.service_general_put("ImmigrationServices/PutVisaDeregistration", this.entryVisa).subscribe((function (data) {
            if (data.success) {
                console.log(data);
                var dialog = _this._dialog.open(general_message_component_1.DialogGeneralMessageComponent, {
                    data: {
    ...
    DialogVisaDeregistrationComponent = __decorate([
        core_1.Component({
    ...
    return DialogVisaDeregistrationComponent;
}());
exports.DialogVisaDeregistrationComponent = DialogVisaDeregistrationComponent;
