...
@Component({
  selector: 'app-dialog-documents-admin-center-services',
  templateUrl: './dialog-documents-admin-center-services.component.html',
  styleUrls: ['./dialog-documents-admin-center-services.component.css']
})
export class DialogDocumentsAdminCenterServicesComponent implements OnInit {

  constructor(public dialogRef: MatDialogRef<DialogDocumentsAdminCenterServicesComponent>,
...
this.temporalDocument.status = 1;
