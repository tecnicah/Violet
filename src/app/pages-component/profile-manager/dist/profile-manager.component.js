...
exports.ProfileManagerComponent = void 0;
...
var ProfileManagerComponent = /** @class */ (function () {
    function ProfileManagerComponent(_services, _routerParams, _dialog, _permissions) {
        this._services = _services;
        this._routerParams = _routerParams;
        this._dialog = _dialog;
        this._permissions = _permissions;
        this.ca_assignedTeam = [];
        this.ca_countryLeader = [];
        this.ca_cliente = [];
    ...
    ProfileManagerComponent.prototype.goBack = function () {
        window.history.back();
    };
    ProfileManagerComponent.prototype.initPageSettings = function () {
        this.user = JSON.parse(localStorage.getItem('userData'));
    ...
    ProfileManagerComponent.prototype.verificaNodos = function () {
    ...
    ProfileManagerComponent.prototype.catalogos = function () {
    ...
    ProfileManagerComponent.prototype.getCity = function () {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.img = function (event) {
        var _this = this;
        console.log(event);
    ...
    ProfileManagerComponent.prototype.addVehicle = function () {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.editVehicle = function (data, i) {
        var _this = this;
        var dialogRef = this._dialog.open(dialog_add_vahicle_consultant_component_1.DialogAddVahicleConsultantComponent, {
            width: "90%",
            data: data
    ...
    ProfileManagerComponent.prototype.addContact = function () {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.editContact = function (data, i) {
        var _this = this;
        var dialogRef = this._dialog.open(dialog_emergency_contact_component_1.DialogEmergencyContactComponent, {
            width: "90%",
            data: data
    ...
    ProfileManagerComponent.prototype.addBenefit = function () {
    ...
    ProfileManagerComponent.prototype.addDocument = function () {
        var _this = this;
    ...
    //ELIMINAR DOCUMENTO//
    ProfileManagerComponent.prototype.deleteDocument = function (i) {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.paymentInformation = function (event) {
        //  console.log(event);
        if (event.checked) {
            this.show = true;
        }
    ...
    ProfileManagerComponent.prototype.getNameOffice = function (id) {
    ...
    ProfileManagerComponent.prototype.getPhotoOffice = function (id) {
        for (var i = 0; i < this.ca_office.length; i++) {
            if (this.ca_office[i].id == id) {
    ...
    ProfileManagerComponent.prototype.deleteOffice = function (i) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    ProfileManagerComponent.prototype.addOffice = function () {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.addCountry = function () {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.deleteCountry = function (i) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    ProfileManagerComponent.prototype.getNameCountry = function (id) {
    ...
    ProfileManagerComponent.prototype.getImageCountry = function (id) {
        for (var i = 0; i < this.ca_country.length; i++) {
            if (this.ca_country[i].id == id) {
    ...
    ProfileManagerComponent.prototype.addOperationLeader = function () {
        var _this = this;
    ...
    ProfileManagerComponent.prototype.deleteOperationLeader = function (i) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
    ...
    //********************************************************************************//
    //FUNCION PARA AGREGAR NUEVO OPERATION LEADER//
    ProfileManagerComponent.prototype.addAssignedTeam = function () {
        var _this = this;
        var dialogRef = this._dialog.open(dialog_add_assigned_team_component_1.DialogAddAssignedTeamComponent, {
            width: "350px"
        });
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result.success) {
                result.createdBy = _this.data_coordinator.id;
                _this.data_coordinator.operationLeaderConsultantNavigations.push(result);
            }
        });
    };
    //FUNCION PARA ELIMINAR OPERATION LEADER//
    ProfileManagerComponent.prototype.deleteAssignedTeam = function (i) {
        var _this = this;
        var dialogRef = this._dialog.open(general_confirmation_component_1.GeneralConfirmationComponent, {
            data: {
                header: "Delete confirmation",
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            console.log(result);
            if (result) {
                _this.data_coordinator.operationLeaderConsultantNavigations.splice(i, 1);
            }
        });
    };
    //********************************************************************************//
    //FUNCIONA PARA TRAER NOMBRE DE PRIVACIDAD//
    ProfileManagerComponent.prototype.getNamePrivacy = function (id) {
    ...
    ProfileManagerComponent.prototype.getNameDocument = function (id) {
        // let document;
    ...
    ProfileManagerComponent.prototype.getDocumentStatus = function (id) {
    ...
    //GET DATA TEAM NAME//
    ProfileManagerComponent.prototype.getDataTeam = function (id) {
    ...
    ProfileManagerComponent.prototype.getDataTeamTile = function (id) {
        for (var i = 0; i < this.ca_assignedTeam.length; i++) {
            if (this.ca_assignedTeam[i].id == id) {
    ...
    ProfileManagerComponent.prototype.getDataTeamPhoto = function (id) {
        for (var i = 0; i < this.ca_assignedTeam.length; i++) {
            if (this.ca_assignedTeam[i].id == id) {
    ...
    ProfileManagerComponent.prototype.getVehicle = function (id) {
    ...
    ProfileManagerComponent.prototype.save = function () {
        var _this = this;
